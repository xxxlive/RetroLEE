...
class MolSeq:
    def __init__(self, rxn_smi, edits_seq):
        self.rxn_smi = rxn_smi
        self.edits_seq = edits_seq
        pass
...
class RxnGraph:
    ...
    # def build_edit_graph(self):
    #     if self.edit_to_apply[0] != 'Attaching LG':
    #         return None
    #     lg_smi = self.edit_to_apply[1]
    ...
    def get_components(self, attrs: List = ['prod_graph', 'edit_to_apply', 'edit_atom', 'lg_mol']) -> Tuple:
        """ 
